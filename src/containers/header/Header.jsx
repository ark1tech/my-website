  ...
  return (
    <div id = "home" class = "snap-start flex md:flex-row flex-col pt-[12rem] pb-[9.5rem] md:px-40 px-10 justify-center">
      <div id = "text">
        ...
        <p class = "word text-center w-full text-white font-[200] tracking-[0.2em] pl-1.5 pt-6 pb-10"> I'm a <span class = "font-[400]"> frontend developer </span> and  <br></br> a <span class = "font-[400]"> data science enthusiast </span> <br></br> from UP Diliman. </p>
